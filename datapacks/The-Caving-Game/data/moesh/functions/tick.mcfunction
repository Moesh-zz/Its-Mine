...
execute as @a[tag=!Registered] run function moesh:player/register
...
execute if score GameState gameVariable matches 2 if entity @a[scores={reset=1..32}] run function moesh:reset
execute if score GameState gameVariable matches 2 if entity @a[scores={reset=33}] run function moesh:reset/legacy