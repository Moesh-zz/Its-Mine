...
execute unless entity @a[nbt={Inventory:[{id:"minecraft:diamond_pickaxe"}]}] run give @s minecraft:diamond_pickaxe{Unbreakable:1b,AttributeModifiers:[{AttributeName:"generic.attackSpeed",Name:"generic.attackSpeed",Amount:-2d,Operation:0,UUIDLeast:441480L,UUIDMost:965428L,Slot:"mainhand"},{AttributeName:"generic.attackDamage",Name:"generic.attackDamage",Amount:14d,Operation:0,UUIDLeast:995521L,UUIDMost:423040L,Slot:"mainhand"}]}
